 ...
 * generated in the mockPackage package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetTransferOptionResponseGetTransferOptionResult_QNAME = new QName("http://tempuri.org/", "getTransferOptionResult");
    ...
    private final static QName _CommitOrderResponseCommitOrderResult_QNAME = new QName("http://tempuri.org/", "commitOrderResult");
    private final static QName _GetDataUsingDataContractComposite_QNAME = new QName("http://tempuri.org/", "composite");
    private final static QName _SetTransferOptionResponseSetTransferOptionResult_QNAME = new QName("http://tempuri.org/", "setTransferOptionResult");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: mockPackage
     * 
     */
    ...
    /**
     * Create an instance of {@link SetTransferOptionResponse }
     * 
     */
    public SetTransferOptionResponse createSetTransferOptionResponse() {
        return new SetTransferOptionResponse();
    }
    ...
    /**
     * Create an instance of {@link CommitOrderResponse }
     * 
     */
    public CommitOrderResponse createCommitOrderResponse() {
        return new CommitOrderResponse();
    }

    /**
     * Create an instance of {@link CommitOrder }
     * 
     */
    public CommitOrder createCommitOrder() {
        return new CommitOrder();
    }

    /**
     * Create an instance of {@link GetTransferOptionResponse }
     * 
     */
    public GetTransferOptionResponse createGetTransferOptionResponse() {
        return new GetTransferOptionResponse();
    }

    /**
     * Create an instance of {@link GetTransferOption }
     * 
     */
    public GetTransferOption createGetTransferOption() {
        return new GetTransferOption();
    }

    /**
     * Create an instance of {@link SetTransferOption }
     * 
     */
    public SetTransferOption createSetTransferOption() {
        return new SetTransferOption();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "getTransferOptionResult", scope = GetTransferOptionResponse.class)
    public JAXBElement<String> createGetTransferOptionResponseGetTransferOptionResult(String value) {
        return new JAXBElement<String>(_GetTransferOptionResponseGetTransferOptionResult_QNAME, String.class, GetTransferOptionResponse.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "commitOrderResult", scope = CommitOrderResponse.class)
    public JAXBElement<String> createCommitOrderResponseCommitOrderResult(String value) {
        return new JAXBElement<String>(_CommitOrderResponseCommitOrderResult_QNAME, String.class, CommitOrderResponse.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "setTransferOptionResult", scope = SetTransferOptionResponse.class)
    public JAXBElement<String> createSetTransferOptionResponseSetTransferOptionResult(String value) {
        return new JAXBElement<String>(_SetTransferOptionResponseSetTransferOptionResult_QNAME, String.class, SetTransferOptionResponse.class, value);
    }
